...
class LoginForm(AuthenticationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update({
            'class': 'block w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800/80 pl-11 pr-4 py-3 text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 text-sm transition duration-150',
            'placeholder': 'Ingresa tu usuario',
            'autocomplete': 'username',
        })
        self.fields['password'].widget.attrs.update({
            'class': 'block w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800/80 pl-11 pr-11 py-3 text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 text-sm transition duration-150',
            'placeholder': '••••••••',
